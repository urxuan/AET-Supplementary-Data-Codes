...
Recon_filename = ['Resire_CoPdPt_NoRadmDefocus_cov35pm_Dose1p7e4_BM3DOPT_S1p0N1000.mat'] % 
ourputstring_prefix = ['polyn_tracing_CoPdPt_NoRadmDefocus_cov35pm_Dose1p7e4_BM3DOPT_S1p0N1000']
Rec_ourput_prefix = ['Rec_CoPdPt_NoRadmDefocus_cov35pm_Dose1p7e4_BM3DOPT_S1p0N1000']
%% load reconstructed 3D volume
Dsetvol0 = importdata(Recon_filename);
Dsetvol0 = Dsetvol0.reconstruction;
Mask=importdata('./Mask_CoPdPt_NoRadmDefocus.mat');
...
maxNum      = min(140000,length(sortInd));
