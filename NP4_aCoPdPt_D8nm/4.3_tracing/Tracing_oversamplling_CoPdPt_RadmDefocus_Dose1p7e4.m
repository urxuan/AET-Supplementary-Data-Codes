...
Recon_filename = ['Resire_CoPdPt_RadmDefocus_cov35pm_Dose1p7e4_BM3DOPT_S2p0N1000.mat'] % 
ourputstring_prefix = ['polyn_tracing_CoPdPt_RadmDefocus_cov35pm_Dose1p7e4_BM3DOPT_S2p0N1000']
Rec_ourput_prefix = ['Rec_CoPdPt_RadmDefocus_cov35pm_Dose1p7e4_BM3DOPT_S2p0N1000']
%% load reconstructed 3D volume
Dsetvol0 = importdata(Recon_filename);
Dsetvol0 = Dsetvol0.reconstruction;
Mask=importdata('./Mask_CoPdPt_RadmDefocus.mat');
...
%% get the local maxima from the reconstruction volume    
   ...
   dilatedBW    = imdilate(FinalVol, se);
    ...
    maxNum      = min(160000,length(sortInd));
