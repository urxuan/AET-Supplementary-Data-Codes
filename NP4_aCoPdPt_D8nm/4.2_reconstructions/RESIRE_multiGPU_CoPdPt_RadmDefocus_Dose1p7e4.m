...
projections = importdata('Proj_CoPdPt_RadmDefocus_cov35pm_Dose1p7e4_BM3DOPT.mat');
angles      = importdata('CoPdPt_Angle_Dose1p7e4.mat');
%figure();img(projections,'colormap','gray')
%%
...
%figure();img(cal_projs,[],projections_refined,[],'colormap','gray')
%% Cal R
...
OBJ.R1=R1;
%%
%save("Resire_CoPdPt_RadmDefocus_cov35pm_Dose1p7e4_BM3DOPT_S2p0N1000.mat","OBJ",'-v7.3')