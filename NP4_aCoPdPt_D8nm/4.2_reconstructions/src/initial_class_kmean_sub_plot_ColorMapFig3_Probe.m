function [temp_model, temp_atomtype] = initial_class_kmean_sub_plot_ColorMapFig3_Probe(rec, curr_model, curr_type, classify_info,y_lim,x_lim)
...
lgd = legend('Non-atoms','Co: 92.5%','Pd: 99.0%','Pt: 100%');
lgd.Box = 'off'; 
