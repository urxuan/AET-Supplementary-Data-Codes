...
%% load rec data
RESIRE=load('Rec_CoPdPt_NoRadmDefocus_BM3D_RefinedAngle_S1p0N1000_ov3.mat');
FinalVol=RESIRE.FinalVol;
%% load tracing data
load('polyn_tracing_CoPdPt_NoRadmDefocus_BM3D_RefinedAngle_S1p0N1000_result.mat') % -140000
...
[temp_model_plot, temp_atomtype_plot] = Plot_hist_CoPdPt_ExtFig7b(FinalVol, temp_model_plot,temp_atomtype_plot, classify_info_plot,1500,18);
return
%% Output


save('Model_CoPdPt_NoRadmDefocus_BM3D_RefinedAngle_S1p0N1000.mat',"temp_atomtype","temp_model");
