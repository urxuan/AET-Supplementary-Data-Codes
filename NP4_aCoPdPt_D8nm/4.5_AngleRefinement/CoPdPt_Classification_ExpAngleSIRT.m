...
%return
%% load rec data
RESIRE=load('Rec_CoPdPt_NoRadmDefocus_BM3D_ExpAngleSIRT_M1000_ov3.mat');
FinalVol=RESIRE.FinalVol;
%%
load('polyn_tracing_CoPdPt_NoRadmDefocus_BM3D_ExpAngleSIRT_M1000_result.mat') % 
...
[temp_model_plot, temp_atomtype_plot] = Plot_hist_CoPdPt_ExtFig7d(FinalVol*900, temp_model_plot,temp_atomtype_plot, classify_info_plot,1500,18);
return
%% Output
save('Model_CoPdPt_NoRadmDefocus_BM3D_ExpAngleSIRT_M1000.mat',"temp_atomtype","temp_model");
