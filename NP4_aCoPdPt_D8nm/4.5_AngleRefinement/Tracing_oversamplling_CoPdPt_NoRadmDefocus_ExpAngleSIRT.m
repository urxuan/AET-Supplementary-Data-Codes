...
Recon_filename = ['Resire_CoPdPt_NoRadmDefocus_BM3D_ExpAngleSIRT_M1000.mat'] % 
ourputstring_prefix = ['polyn_tracing_CoPdPt_NoRadmDefocus_BM3D_ExpAngleSIRT_M1000']
Rec_ourput_prefix = ['Rec_CoPdPt_NoRadmDefocus_BM3D_ExpAngleSIRT_M1000']
...
maxNum      = min(90000,length(sortInd));
