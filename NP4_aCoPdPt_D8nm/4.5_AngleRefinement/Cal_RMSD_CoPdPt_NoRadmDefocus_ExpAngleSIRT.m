...
%%
Model=load('Model_CoPdPt_NoRadmDefocus_BM3D_ExpAngleSIRT_M1000.mat'); 

atoms0=Model.temp_model; 
atoms(1,:)=atoms0(1,:);% SIRT
atoms(2,:)=atoms0(2,:); % SIRT
atoms(3,:)=-atoms0(3,:); % SIRT
...
return
%%
%save('RMSD_Model_CoPdPt_NoRadmDefocus_BM3D_ExpAngleSIRT_M1000.mat','dif_Co','dif_Pd','dif_Pt','dif_all','cutoff');
