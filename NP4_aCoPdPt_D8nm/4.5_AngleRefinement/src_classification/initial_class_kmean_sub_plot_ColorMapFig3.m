function [temp_model, temp_atomtype] = initial_class_kmean_sub_plot_ColorMapFig3(rec, curr_model, curr_type, classify_info,y_lim,x_lim)
...
figure; clf;box on;
set(gcf,'Position',[150,150,700,105])
hold on
for i=1:Num_species
...
'FaceColor', FaceColor, 'FaceAlpha', 0.2,'linewidth',1);
