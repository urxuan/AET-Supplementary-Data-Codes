function [temp_model, temp_atomtype] = Plot_hist_CoPdPt_ColorMapFig3(rec, curr_model, curr_type, classify_info,y_lim,x_lim)
...
%lgd = legend('Non-atoms','Co: 93.9%','Pd: 98.7%','Pt: 100%');
%lgd = legend('Non-atoms','Co: 95.1%','Pd: 99%','Pt: 100%');% Without random defocus
%lgd = legend('Non-atoms','Co: 95.1%, RMSD: 29.0 pm','Pd: 99.0%, RMSD: 11.7 pm','Pt: 100%, RMSD:5.9 pm');
