...
%%
Model=load('Model_CoPdPt_NoRadmDefocus_BM3D_ExpAngle_S1p0N1000.mat'); 
...
return
%%
%save('RMSD_Model_CoPdPt_NoRadmDefocus_BM3D_ExpAngle_S1p0N1000.mat','dif_Co','dif_Pd','dif_Pt','dif_all','cutoff');
