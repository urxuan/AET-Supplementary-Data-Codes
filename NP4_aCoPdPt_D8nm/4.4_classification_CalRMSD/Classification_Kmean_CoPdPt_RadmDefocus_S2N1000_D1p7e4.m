...
addpath('../4.3_tracing');
%% load rec data
RESIRE=load('Rec_CoPdPt_RadmDefocus_cov35pm_Dose1p7e4_BM3DOPT_S2p0N1000_ov3.mat');
FinalVol=RESIRE.FinalVol;
%% load tracing data
load('polyn_tracing_CoPdPt_RadmDefocus_cov35pm_Dose1p7e4_BM3DOPT_S2p0N1000_result.mat') % -140000
...
return
%% Output
save('Model_CoPdPt_RadmDefocus_cov35pm_Dose1p7e4_S2N1000.mat',"temp_atomtype","temp_model");
