function [temp_model, temp_atomtype] = Plot_hist_kmean_ColorMap_NoRadmDefocus(rec, curr_model, curr_type, classify_info,y_lim,x_lim)
...
lgd = legend('Non-atoms','Co: 95.1%','Pd: 99%','Pt: 100%');
lgd.Box = 'off'; 
