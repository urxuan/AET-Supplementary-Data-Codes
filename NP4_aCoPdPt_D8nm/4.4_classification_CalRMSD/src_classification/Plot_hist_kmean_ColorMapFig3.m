function [temp_model, temp_atomtype] = Plot_hist_kmean_ColorMapFig3(rec, curr_model, curr_type, classify_info,y_lim,x_lim)
...
lgd = legend('Non-atoms','Co: 90%','Pd: 98.3%','Pt: 100%');
lgd.Box = 'off'; 
