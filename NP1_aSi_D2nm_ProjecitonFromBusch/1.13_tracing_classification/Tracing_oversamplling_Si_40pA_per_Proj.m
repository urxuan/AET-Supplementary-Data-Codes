...
Recon_filename = [homeDir 'Resire_Si_40pA_BM3D.mat'] % rec_df_Ge_220326_t1_ref_wonp.mat %ReconObj_Ge_220326_Run1.mat% ReconObj_Ge_220326_Run4000
ourputstring_prefix = [inputDir 'polyn_tracing_40pA_N5000']
%% load reconstructed 3D volume
Dsetvol0 = importdata(Recon_filename);
Dsetvol = Dsetvol0.reconstruction;
...
save('Rec_Si_40pA_BM3D_ov3.mat','FinalVol')
...
Res     = 0.195/ov;  minDist  = 2.0/Res;     SearchRad = ov;
