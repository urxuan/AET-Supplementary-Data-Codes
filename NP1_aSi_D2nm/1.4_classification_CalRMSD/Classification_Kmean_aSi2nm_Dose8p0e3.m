...
addpath('../1.3_tracing');
%% load rec volume 
RESIRE=load('Rec_aSi2nm_FosCetr_Dose8p0e3_cov35pm_BM3D_S0p25N200_ov3.mat');
FinalVol=RESIRE.FinalVol;
%% load tracing data
load('polyn_tracing_aSi2nm_FosCetr_Dose8p0e3_cov35pm_BM3D.mat') %
...
classify_info2 = struct('Num_species', 1,  'halfSize',  3,  'plothalfSize',  3, ...
...
%% Output
save('Model_aSi2nm_FoscCenter_Dose8p0e3_cov35pm_BM3D.mat',"temp_atomtype","temp_model");
