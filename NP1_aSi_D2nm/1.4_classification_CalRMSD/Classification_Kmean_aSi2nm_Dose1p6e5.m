...
addpath('../1.3_tracing');
%% load rec volume 
RESIRE=load('Rec_aSi2nm_FosCetr_Dose1p6e5_cov35pm_BM3D_S0p25N200_ov3.mat');
FinalVol=RESIRE.FinalVol;
%% load tracing data
load('polyn_tracing_aSi2nm_FosCetr_Dose1p6e5_cov35pm_BM3D.mat') %

exitFlagArr0=exitFlagArr(:,1:end); % 
TotPosArr0=TotPosArr(1:end,:);
maxXYZ0=maxXYZ(1:end,:);
atom_pos_tracing = TotPosArr0(exitFlagArr0==0,:); %
%% classification by K-mean method
...
%% Output
save('Model_aSi2nm_FoscCenter_Dose1p6e5_cov35pm_BM3D.mat',"temp_atomtype","temp_model");
