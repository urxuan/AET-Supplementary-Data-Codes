function [temp_model, temp_atomtype] = Plot_hist_ColorMap_D1p6e5(rec, curr_model, curr_type, classify_info,xscale,yscale)
...
lgd = legend('Non-atoms','Si: 75.1%','Ge: 99.9%','Sn: 100%');% dose1p6e5,No probe
lgd.Box = 'off'; 
