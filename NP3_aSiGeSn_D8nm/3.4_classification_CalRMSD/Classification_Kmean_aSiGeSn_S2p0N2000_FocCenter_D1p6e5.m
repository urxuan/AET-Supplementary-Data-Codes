...
%% load rec volume
RESIRE=load('Rec_aSiGeSn_FosCetr_Dose1p6e5_cov35pm_BM3D_S2p0N2000_ov3.mat');
FinalVol=RESIRE.FinalVol;
%% load tracing results
load('polyn_tracing_aSiGeSn_FosCetr_Dose1p6e5_cov35pm_BM3D_result.mat') 
...
classify_info2 = struct('Num_species', 2,  'halfSize',  2,  'plothalfSize',  4, ...
...
[temp_model_plot, temp_atomtype_plot] = Plot_hist_ColorMap_D1p6e5(FinalVol, temp_model_plot,temp_atomtype_plot, classify_info_plot,0.95,1.1);
%% Output

% save('Model_aSiGeSn8nm_FoscCenter_Dose1p6e5_cov35pm_BM3D.mat',"temp_atomtype","temp_model");
