...
Recon_filename = ['Resire_aSiGeSn_FosCetr_Dose1p6e5_cov35pm_BM3D_S2p0N2000.mat'] % 
ourputstring_prefix = ['polyn_tracing_aSiGeSn_FosCetr_Dose1p6e5_cov35pm_BM3D']
Rec_ourput_prefix = ['Rec_aSiGeSn_FosCetr_Dose1p6e5_cov35pm_BM3D_S2p0N2000']
%% load reconstructed 3D volume
Dsetvol0 = importdata(Recon_filename);
Dsetvol0 = Dsetvol0.reconstruction;
Mask=importdata('./Mask_aSiGeSn_8nm.mat');
...
MaxIter = 14;       CritIter = 7;         Th        = 0.00e-2; % 1.5e-2; 
Res     = 0.347/ov;  minDist  = 1.92/Res;     SearchRad = 3*1;% ov*3;
...
%% get the local maxima from the reconstruction volume    
   ...
   dilatedBW    = imdilate(FinalVol, se);
    ...
    maxNum      = min(150000,length(sortInd));
