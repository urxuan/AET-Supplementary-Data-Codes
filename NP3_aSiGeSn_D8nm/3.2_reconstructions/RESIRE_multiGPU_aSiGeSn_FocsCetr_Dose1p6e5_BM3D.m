...
projections = importdata('aSiGeSn_FosCetr_Dose1p6e5_cov35pm_BM3DOPT.mat');
angles      = importdata('SiGeSn_Angle.mat');
...
OBJ.R1=R1;
%%
%save("Resire_aSiGeSn_FosCetr_Dose1p6e5_cov35pm_BM3D_S2p0N2000.mat","OBJ",'-v7.3')
