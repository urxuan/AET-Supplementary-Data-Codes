...
Recon_filename = ['Resire_aSi9nm_FosCetr_Dose1p6e4_cov35pm_BM3D_S1p0N200.mat'] % 
ourputstring_prefix = ['polyn_tracing_aSi9nm_FosCetr_Dose1p6e4_cov35pm_BM3D']
Rec_ourput_prefix = ['Rec_aSi9nm_FosCetr_Dose1p6e4_cov35pm_BM3D_S1p0N200']
%% load reconstructed 3D volume
Dsetvol0 = importdata(Recon_filename);
Dsetvol0 = Dsetvol0.reconstruction;
Mask=importdata('Mask_aSi_9nm_cov35pm.mat');
...
Res     = 0.347/ov;  minDist  = 1.65/Res;     SearchRad = 3;
