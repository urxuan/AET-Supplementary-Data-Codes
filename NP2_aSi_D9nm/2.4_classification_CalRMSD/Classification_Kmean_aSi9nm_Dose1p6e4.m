...
addpath('../2.3_tracing');
%% load data
RESIRE=load('Rec_aSi9nm_FosCetr_Dose1p6e4_cov35pm_BM3D_S1p0N200_ov3.mat');%
FinalVol=RESIRE.FinalVol;
load('polyn_tracing_aSi9nm_FosCetr_Dose1p6e4_cov35pm_BM3D_result.mat')%reuslts
...
%% Output
save('Model_aSi9nm_FoscCenter_Dose1p6e4_cov35pm_BM3D.mat',"temp_atomtype","temp_model");
