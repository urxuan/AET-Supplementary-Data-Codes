...
addpath('../2.3_tracing');
%% load data
RESIRE=load('Rec_aSi9nm_FosCetr_Dose8p0e3_cov35pm_BM3D_S1p0N200_ov3.mat');%
FinalVol=RESIRE.FinalVol;
load('polyn_tracing_aSi9nm_FosCetr_Dose8p0e3_cov35pm_BM3D_result.mat')%reuslts
...
[temp_model_ref, temp_atomtype_ref] = initial_class_kmean_sub_plot_ColorMap(FinalVol*10, atom_pos_tracing', classify_info1,3000);  
%% remove non-atoms
...
%% Output
save('Model_aSi9nm_FoscCenter_Dose8p0e3_cov35pm_BM3D.mat',"temp_atomtype","temp_model");
