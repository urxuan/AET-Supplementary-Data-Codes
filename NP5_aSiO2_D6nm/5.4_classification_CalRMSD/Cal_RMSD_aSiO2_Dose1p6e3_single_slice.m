...
%% Classified atoms
Model=load('Model_aSiO2_Dose1p6e3_single_slice_cov35pm_S2p0N1000.mat'); %Results dose 1p6e4, cov=35 pm

atoms=Model.temp_model;
atoms_type=Model.temp_atomtype;
ID_nonAtom=find(atoms_type==0);
ID_O=find(atoms_type==1);% 
ID_Si=find(atoms_type==2);
ID_all=[ID_O ID_Si];
%%
