...
Recon_filename = ['Resire_aSiO2_Dose1p6e3_single_slice_cov35pm_S2p0N1000.mat'] % 
ourputstring_prefix = ['polyn_tracing_aSiO2_Dose1p6e3_single_slice_cov35pm_S2p0N1000']
Rec_ourput_prefix = ['Rec_aSiO2_Dose1p6e3_single_slice_cov35pm_S2p0N1000']
%% load reconstructed 3D volume
Dsetvol0 = importdata(Recon_filename);
Dsetvol0 = Dsetvol0.reconstruction;
Mask=importdata('./aSiO2_Mask.mat');
...
Res     = 0.34517/ov;  minDist  = 1.0/Res;     SearchRad = 3;% 
...
maxNum      = min(500000,length(sortInd));
